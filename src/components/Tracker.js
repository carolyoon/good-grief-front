    ...
    if (this.props.stageId === 2) {
      return (
        <header>
          ...
          <a href='/anger' onClick={this.handle} style={{background: '#DF744A', color: '#FFFFFF'}} >Anger</a>
    ...
    if (this.props.stageId === 3) {
      return (
        <header>
          ...
          <a href='/bargaining' onClick={this.handle} style={{background: '#DF744A', color: '#FFFFFF'}} >Bargaining</a>
          <a href='/depression' onClick={this.handle} >Depression</a>
          <a href='/acceptance' onClick={this.handle} >Acceptance</a>
        </header>
      )
    ...
    if (this.props.stageId === 4) {
      return (
        <header>
          ...
          <a href='/anger' onClick={this.handle} >Anger</a>
          <a href='/bargaining' onClick={this.handle} >Bargaining</a>
          <a href='/depression' onClick={this.handle} style={{background: '#DF744A', color: '#FFFFFF'}} >Depression</a>
          <a href='/acceptance' onClick={this.handle} >Acceptance</a>
        </header>
      )
    }
    if (this.props.stageId === 5) {
      return (
        <header>
          ...
          <a href='/bargaining' onClick={this.handle} >Bargaining</a>
          <a href='/depression' onClick={this.handle} >Depression</a>
          <a href='/acceptance' onClick={this.handle} style={{background: '#DF744A', color: '#FFFFFF'}} >Acceptance</a>
        </header>
      )
    }
  }
